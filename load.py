...
data_ = []
data_.append(data.extract_url_book()) 
_data = pd.DataFrame(data_, columns = ["product_page_url", "book_title", "universal_product_code(upc)", "price_including_tax", "price_excluding_tax", "tax", "quantity_available", "delete", "product_description", "category", "review_rating", "image_url"])
...
_data = _data.drop("delete", axis=1)
